<!-- GERADO por scripts/sync-ai-commands.sh a partir de .claude/commands/retomar.md — edite lá e re-rode o script -->
---
...
2. Se ${input} indicar qual, use-o; senão, se houver mais de um, pergunte ao usuário qual retomar; se houver só um, retome-o direto.
