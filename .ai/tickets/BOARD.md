# BOARD — quadro de tickets

> Índice vivo. Todo agente que muda o status de um ticket atualiza a linha correspondente aqui. Uma linha por ticket, no formato: `ID — título (tipo, prioridade, fase)`.
